...
nltk.data.path.append('C:/Users/leidy/AppData/Roaming/nltk_data')
...
texto = """
Mi nombre es Leidy y soy una estudiante del sena, en lo personal disfruto de tejer coser y pasar tiempo con mi hijo en lo profesional soy especialie 
de soporte TI.
Mi compañero de estudio esJheyson Galvis, soy profesor, me gusta caminar y viajar, dormir."""
